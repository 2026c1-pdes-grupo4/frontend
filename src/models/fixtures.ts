...
export const properties: Property[] = [
  ...
  },
  {
    ...
    propertyType: 'LAND',
    price: 140000,
    address: 'Chacra de la Cruz, Lote 12',
    city: 'Capilla del Señor',
    province: 'Buenos Aires',
    areaSq: 1500,
    rooms: 0,
    description: 'Excelente lote central en Chacras de la Cruz, ideal para proyecto de fin de semana.',
    available: false,
    agencyId: 1,
  ...
  {
    id: 10,
    propertyType: 'RANCH_FARM',
    price: 1200000,
    address: 'Ruta 14 Km 5, Establecimiento El Ceibo',
    city: 'Gualeguaychú',
    province: 'Entre Ríos',
    areaSq: 150000,
    rooms: 6,
    description: 'Establecimiento rural mixto, excelente aptitud agrícola-ganadera y casco histórico.',
    available: true,
    agencyId: 5,
  ...
  },
  {
    ...
    propertyType: 'RANCH_FARM',
    price: 2100000,
    address: 'Ruta Pres. Perón Km 22, Campo Don Juan',
    city: 'Pergamino',
    province: 'Buenos Aires',
    areaSq: 850000,
    rooms: 4,
    description: 'Campo de alta productividad en zona núcleo de Pergamino. Excelente rinde.',
    available: true,
    agencyId: 5,
